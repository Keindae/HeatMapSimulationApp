...
- [x] Removed _.pluck in favor of _.googleMap with iteratee shorthand
...
declare namespace _ {
    ...
    interface LoDashStatic {
        ...
        * keyBy, initial, intersection, invert, invoke, keys, googleMap, max, memoize, merge, min,
    ...
    **/
    ...
    interface LoDashStatic {
         ...
         * have the properties of the given object, else false.
         *
         * Many lodash methods are guarded to work as iteratees for methods like _.every, _.filter, _.googleMap, _.mapValues,
         * _.reject, and _.some.
         *
